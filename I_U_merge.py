...
#
iu= i.merge(u,how='outer',on=["WY_id",'calf_num'],suffixes=('_I','_U'))
iu2=iu.groupby(['WY_id','calf_num']).agg('first')
iu3=pd.concat([i,u,lb,mc,sd],axis=0)
iu4=iu3.groupby(['WY_id','calf_num','datex'],axis=0).agg('first')
iu4.to_csv('F:\\COWS\\data\\insem_data\\i_u_merge.csv')
