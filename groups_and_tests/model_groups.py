...
class ModelGroups:
    ...
    def load_and_process(self):
        ...
        self.WD_weekly = self.WD.wet_dry_weekly[self.WD.wet_dry_weekly['week'] >= pd.to_datetime(self.startdate)].reset_index(drop=True)
    ...
    def write_to_csv (self):
        self.wet.to_csv("F:\\COWS\\data\\status\\wet.csv")
