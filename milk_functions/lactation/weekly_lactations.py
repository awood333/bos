...
class WeeklyLactations():
    ...
    def write_to_csv(self):
        ...
        self.live_lact_wk_2.to_csv('F:\\COWS\\data\\milk_data\\lactations\\weekly\\live_lact_wk_2.csv')
        self.live_lact_wk_3.to_csv('F:\\COWS\\data\\milk_data\\lactations\\weekly\\live_lact_wk_3.csv')
        self.live_lact_wk_4.to_csv('F:\\COWS\\data\\milk_data\\lactations\\weekly\\live_lact_wk_4.csv')
        self.live_lact_wk_5.to_csv('F:\\COWS\\data\\milk_data\\lactations\\weekly\\live_lact_wk_5.csv')
