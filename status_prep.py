...
#
lb=pd.read_csv('F:\\COWS\\data\\csv_files\\live_births.csv',    parse_dates=['b_date'], date_format='%m/%d/%Y')
bd=pd.read_csv('F:\\COWS\\data\\csv_files\\birth_death.csv',    parse_dates=['death_date','birth_date'], date_format='%m/%d/%Y')
u=pd.read_csv ('F:\\COWS\\data\\csv_files\\ultra.csv',          parse_dates=['ultra_date'], date_format='%m/%d/%Y')
i=pd.read_csv ('F:\\COWS\\data\\csv_files\\insem.csv',          parse_dates=['insem_date'], date_format='%m/%d/%Y')
s=pd.read_csv ('F:\\COWS\\data\\csv_files\\stop_dates.csv',     parse_dates=['stop'], date_format='%m/%d/%Y')
