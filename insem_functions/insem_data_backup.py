...
class InsemDataBackup:
    ...
    def read_csv_data(self):
        ...
        self.heifbd = pd.read_csv  ('F:\\COWS\\data\\csv_files\\heifers_birth_death.csv')
    ...
    def write_to_csv(self):
        ...
        self.heifbd.to_csv   ('F:\\COWS\\data\\insem_data\\insem_backup\\heifer_birth_death\\heifer_birth_death_'+tdy+'.csv')        
        ...
        self.heifbd.to_csv   ('E:\\COWS\\data_backup\\insem_data\\heifer_birth_death\\heifer_birth_death_'+tdy+'.csv')
